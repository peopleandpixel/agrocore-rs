...
OPT-009 Reporting-Service Timeout und Paginierung (P2). Datei: crates/reporting-service/src/main.rs. Aktion: Paginierung auf 500 geändert (4x 100→500), Timeout 30s aktiv, Tracing-Log bei Timeout (info). Status: erledigt.

OPT-010 Weather-Service und Geometry-Service Timeout (P3). Datei: crates/weather-service/src/main.rs + worker.rs + crates/geometry-service/src/main.rs. Aktion: Timeout-Struktur (30s) in weather-service main und worker eingebaut; geometry-service main Timeout eingebaut. Status: erledigt.

Abgeschlossen / Abgebrochen (nur zur Information, nicht mehr aktiv):
- 001, 002, 004, 005, 006, 007, 008, 009, 010: erledigt
