...
### Offen
- [x] **Logging-Aggregation:** Setup von Loki für zentrales Log-Management (via Docker Compose).
- [x] **Grafana Dashboards:** Visualisierung der Prometheus-Metriken (Business-KPIs vs. System-Health).
- [x] **Kubernetes Manifests:** Vorbereitung für den Cluster-Betrieb (Deployment, Services, Ingress).
