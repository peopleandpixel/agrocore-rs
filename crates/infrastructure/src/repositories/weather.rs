...
#[derive(Clone)]
pub struct WeatherStationRepo {
    base: MongoRepository<WeatherStation>,
}
impl WeatherStationRepo {
    pub fn new(c: Collection<WeatherStation>) -> Self {
        Self {
...
#[derive(Clone)]
pub struct WeatherDataRepo {
    base: MongoRepository<WeatherData>,
}
impl WeatherDataRepo {
    pub fn new(c: Collection<WeatherData>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
...
#[derive(Clone)]
pub struct PhenologyRecordRepo {
    base: MongoRepository<PhenologyRecord>,
}
impl PhenologyRecordRepo {
    pub fn new(c: Collection<PhenologyRecord>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
