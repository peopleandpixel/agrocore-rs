...
use agrocore_domain::entities::finance::{
    ...
    FinancialRecord, PACApplication, PACStatus,
};
...
#[derive(Clone)]
pub struct PACApplicationRepo {
    base: MongoRepository<PACApplication>,
}
impl PACApplicationRepo {
    pub fn new(c: Collection<PACApplication>) -> Self {
        Self {
...
#[derive(Clone)]
pub struct CostCenterRepo {
    base: MongoRepository<CostCenter>,
}
impl CostCenterRepo {
    pub fn new(c: Collection<CostCenter>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
...
#[derive(Clone)]
pub struct FinancialRecordRepo {
    base: MongoRepository<FinancialRecord>,
}
impl FinancialRecordRepo {
    pub fn new(c: Collection<FinancialRecord>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
