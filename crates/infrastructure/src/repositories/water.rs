...
use agrocore_domain::entities::water::{
    CreateWaterSourceDto, CreateWaterUsageDto, WaterQuota, WaterSource, WaterUsage,
};
...
#[derive(Clone)]
pub struct WaterSourceRepo {
    base: MongoRepository<WaterSource>,
}
impl WaterSourceRepo {
    pub fn new(c: Collection<WaterSource>) -> Self {
        Self {
...
#[derive(Clone)]
pub struct WaterUsageRepo {
    base: MongoRepository<WaterUsage>,
}
impl WaterUsageRepo {
    pub fn new(c: Collection<WaterUsage>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
...
#[derive(Clone)]
pub struct WaterQuotaRepo {
    base: MongoRepository<WaterQuota>,
}
impl WaterQuotaRepo {
    pub fn new(c: Collection<WaterQuota>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
