...
use agrocore_domain::entities::vineyard::{
    CreateKelterDeliveryDto, CreateVineyardDto, KelterDelivery, Vineyard,
};
...
#[derive(Clone)]
pub struct VineyardRepo {
    base: MongoRepository<Vineyard>,
}
impl VineyardRepo {
    pub fn new(c: Collection<Vineyard>) -> Self {
        Self {
...
#[derive(Clone)]
pub struct KelterDeliveryRepo {
    base: MongoRepository<KelterDelivery>,
}
impl KelterDeliveryRepo {
    pub fn new(c: Collection<KelterDelivery>) -> Self {
        Self {
            base: MongoRepository::new(c),
        }
    }
